...
app.get('/infoConsole', (req,res) => {
    console.log(`Argumentos de entrada: ${JSON.stringify(process.argv,null,'\t')}`)
    console.log(`Path de ejecucion: ${process.execPath}`)
    console.log(`Plataforma: ${process.platform}`)
    console.log(`Version de node: ${process.version}`)
    console.log(`Carpeta corriente: ${process.cwd()}`)
    console.log(`Uso de memoria: ${JSON.stringify(process.memoryUsage(),null,'\t')}`)
    console.log(`Puerto: ${PORT}`)
    console.log(`id de salida: ${process.pid}`)
    console.log(`Numero de CPUs en ejecucion: ${numCPUs}`)
